...
function particles(){var e={particles:{number:{value:20,density:{enable:!0,value_area:800}},color:{value:"#f5f5f5"},shape:{type:["image","image"],stroke:{width:0,color:"#f5f5f5"},polygon:{nb_sides:5},image:{src:"img/bulb.png",width:500,height:750}},opacity:{value:1,random:!1,anim:{enable:!1,speed:1,opacity_min:.1,sync:!1}},size:{value:30,random:!0,anim:{enable:!1,speed:20,size_min:20,sync:!1}},line_linked:{enable:!0,distance:150,color:"#A6A6A6",opacity:.4,width:5},move:{enable:!0,speed:4,direction:"none",random:!1,straight:!1,out_mode:"out",attract:{enable:!1,rotateX:600,rotateY:1200}}},interactivity:{detect_on:"canvas",events:{onhover:{enable:!1,mode:"repulse"},onclick:{enable:!1,mode:"push"},resize:!0},modes:{grab:{distance:400,line_linked:{opacity:1}},bubble:{distance:400,size:40,duration:2,opacity:8,speed:3},repulse:{distance:100},push:{particles_nb:4},remove:{particles_nb:2}}},retina_detect:!0};window.matchMedia("(max-width: 480px)").matches&&(e.particles.number.value=30,e.particles.number.density.value_area=400,e.particles.size.value=15),particlesJS("particles-js",e)}function formEvent(){$("form").submit(function(e){e.preventDefault(),swal("Please wait"),swal.showLoading();var t=$(this);$.ajax({type:"POST",url:"mail.php",data:t.serialize()}).done(function(){swal({title:"Thank you!",text:"This is additional info.",type:"success",allowOutsideClick:!0}),setTimeout(function(){t.trigger("reset")},1e3)}).fail(function(){swal({title:"Oops!",text:"Something went wrong. Please try later.",type:"error",allowOutsideClick:!0})})})}$(function(){$("#t").t({speed:70,blink:400,mistype:20}),particles(),SmoothScroll({pulseAlgorithm:!0,pulseScale:4,pulseNormalize:1}),zenscroll.setup(700,10),formEvent()}),$(document).ready(function(){$(".animated").css("opacity",0);var e="animate-fadeIn-left";new Waypoint({element:document.getElementById(e),handler:function(){$("#"+e).addClass("bounceInLeft").css("opacity",1)},offset:"80%"});var t="animate-fadeIn-right";new Waypoint({element:document.getElementById(t),handler:function(){$("#"+t).addClass("bounceInRight").css("opacity",1)},offset:"80%"})});